...
export declare namespace NTree {
    ...
    type TFieldDataNode<T, TChildFieldName extends string = 'children'> = TBasicDataNode & T & Partial<Record<TChildFieldName, TFieldDataNode<T, TChildFieldName>[]>>;
